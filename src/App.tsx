...
import RegisterAsset from "./pages/assets/Register";
import AssetsDashboard from "./pages/assets/Dashboard";
import AssetsInventory from "./pages/assets/Inventory";
import AssetsManagement from "./pages/assets/Management";
import AssetAssociation from "./pages/associations/Asset";
